...
public class forgotpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 210, 570, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("E:\\inplant_training\\NEW2.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
             ResultSet rs;
            rs = select.getData("select *from users where email='"+Email+"' and securityQuestion ='"+securityQuestion+"'and answer='"+Answer+"'");
        ...
        try
       {
           ...
           {
               check=1;
               InsertUpdateDelete.setData("Update users set user_password ='"+newpassword+"'where email ='"+Email+"'","password set successfully");
               setVisible(false);
