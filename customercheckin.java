...
public class customercheckin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 0, -1, -1));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon("E:\\inplant_training\\home4.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          try
        {
            ...
            if(!price.equals(""))
            {
                ...
                Query="insert into customer(id,name,mobilenumber,nationalitlty,gender,email,idproof,address,checkin,roomno,bed,roomtype,priceperday) values ("+id+",'"+name+"','"+mobilenumber+"','"+nationality+"','"+gender+"','"+email+"','"+idproof+"','"+address+"','"+checkin+"','"+roomno+"','"+bed+"','"+roomtype+"','"+price+"')";
